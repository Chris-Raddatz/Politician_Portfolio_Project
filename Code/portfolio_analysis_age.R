...
paste("Cumulative returns for Democrat portfolio is:", round(portfolio_60_70_cum_returns*100,2),"%")

portfolio_70_cum_returns <- Return.cumulative(portfolio_70_returns_xts, geometric = TRUE)
paste("Cumulative returns for overall portfolio is:", round(portfolio_70_cum_returns*100,2),"%")
...
jpeg(file = "Visualizations/Age Portfolio Returns.png")
